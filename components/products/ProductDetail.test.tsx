...
describe('Product Detail Component', () => {
  describe('data', () => {
    test('should render correct product item data', () => {
    ...
    test('should render correct status if product is out of stock', () => {
  ...
  describe('image gallery', () => {
    test('should not render product name and alt image if name is not available', () => {
      const productItem: ProductItem = generateProductItems(1, 3)[0];
    ...
    test('should not render product image and thumbnail if not exist', () => {
      const productItem: ProductItem = generateProductItems(1, 0)[0];
      render(
        <WebsiteContextProvider value={MockWebsite}>
          <ProductDetail {...productItem} />
  ...
  describe('size and color', () => {
    describe('current variant has both size and color', () => {
      test('should render correct number of corlor and size buttons', () => {
        const productItem: ProductItem = generateProductItems(1, 0)[0];
        render(
          <WebsiteContextProvider value={MockWebsite}>
            <ProductDetail {...productItem} />
      ...
      test('should render correct variant url in color/size button', () => {
        const productItem: ProductItem = generateProductItems(1, 0)[0];
        render(
          <WebsiteContextProvider value={MockWebsite}>
            <ProductDetail {...productItem} />
      ...
      test('should render correct color/size button with active style', () => {
        const productItem: ProductItem = generateProductItems(1, 0)[0];
        render(
          <WebsiteContextProvider value={MockWebsite}>
            <ProductDetail {...productItem} />
    ...
    describe('current variant does not have color', () => {
      ...
      test('should render correct color/size button with active/disabled style', () => {
        const productItem: ProductItem = generateProductItems(1, 0)[0];
        productItem.fields = {
          brand: [{ name: 'Brand name 0' }],
          color: null,
    ...
    describe('current variant does not have both size and color', () => {
      ...
      test('should render correct color/size button with disabled style', () => {
        const productItem: ProductItem = generateProductItems(1, 0)[0];
        productItem.fields = {
          brand: [{ name: 'Brand name 0' }],
          color: null,
  ...
  describe('fields and fields group', () => {
    test('should render correct field groups value', () => {
      const productItem: ProductItem = generateProductItems(1, 0)[0];
    ...
    test('should render correct fields value', () => {
      const productItem: ProductItem = generateProductItems(1, 0)[0];
      productItem.fieldGroups = [
        {
          fieldGroupId: 'Product information',
      ...
      ).toEqual('2023-10-17T00:00:00.000Z');
    ...
    test('should not render field if id is not available', () => {
      const productItem: ProductItem = generateProductItems(1, 0)[0];
      productItem.fieldGroups = [
        {
          fieldGroupId: 'Product information',
  ...
  describe('Similar products and Accessories', () => {
    test('shoud not render Similar products and Accessories if not available', () => {
      const productItem: ProductItem = generateProductItems(1, 0)[0];
      render(
        <WebsiteContextProvider value={MockWebsite}>
          <ProductDetail {...productItem} />
    ...
    test('shoud render correct Similar products and Accessories value', () => {
      const productItem: ProductItem = generateProductItems(1, 0)[0];
